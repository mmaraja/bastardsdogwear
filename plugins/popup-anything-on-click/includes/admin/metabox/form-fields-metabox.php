						...
						<tbody>
							<tr>
								...
								<td align="right" class="paoc-action-btn-wrp" style="width: 100px;">
									...
									<span class="paoc-action-btn paoc-action-del-btn paoc-del-form-field-row" title="<?php esc_html_e('Delete', 'popup-anything-on-click'); ?>"><i class="dashicons dashicons-trash"></i></span>
									<span class="paoc-action-btn paoc-action-drag-btn paoc-drag-form-field-row" title="<?php esc_html_e('Drag', 'popup-anything-on-click'); ?>"><i class="dashicons dashicons-move"></i></span>
								</td>
							</tr>
							<tr>
